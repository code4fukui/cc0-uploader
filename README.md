...
- Stores the uploaded images in the `static/data/` directory
- Provides a list of all uploaded images with direct links

## Usage
1. Open the application in a web browser.
2. Click the "Choose files" button to select one or more images to upload.
3. Click the "CC0 として アップロード" (Upload as CC0) button to upload the images.
